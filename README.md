...
Volume Down button use for taking the inputs by using Google Speech to Text and Volume Up button for Calculate the problem and also speak the answer by using Text to Speech!
